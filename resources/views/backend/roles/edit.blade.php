...
<!--Content Will Goes Here-->
    ...
    <div class="card card-primary card-outline mb-4">
        ...
        <div class="card-body">
            <!--begin::Form-->
            <form action="{{route('roles.update',$role->id)}}" method="PATCH"  enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-3 ">
                            <label class="" style="font-size: 12px">{{ html()->checkbox('permission[]', $value->id, in_array($value->id, $rolePermissions) ? true : false, array('class' => 'name')) }}
